...
subtask_ic120_follow_waypointsと機能は同じであるが、姿勢はdegreeを用いて指定する点が異なる。
...
.. image:: ../images/SubtaskIc120FollowWaypointsDeg.png
   :alt: SubtaskIc120FollowWaypointsDeg
   :width: 400px
   :align: center  
...
.. image:: ../images/Sample_SubtaskIc120FollowWaypointsDeg.svg
