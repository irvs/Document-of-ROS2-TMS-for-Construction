subtask_ic120_follow_waypoints_degの概要
===================================
...
行う。
subtask_ic120_navigate_through_posesと機能は同じであるが、姿勢はdegreeを用いて指定する点が異なる。
...
- **subtask_node** :  "subtask_ic120_nvigate_through_poses_deg"と指定。

.. image:: ../images/SubtaskIc120NavigateTheoughPosesDeg.png
   :alt: SubtaskIc120NavigateTheoughPosesDeg
   :width: 400px
   :align: center  
...
.. image:: ../images/Sample_SubtaskIc120NavigateThroughPosesDeg.svg
   :alt: Sample_SubtaskIc120NavigateThroughPosesDeg
   :width: 400px
   :align: center  
